     ...
     *S1,da,Ckc,Ckw,Cm,Ca,G,f0,f00,Ck0,Ck00,dc0,dw0,ds,Pt0,twomu,
     *alamda,vk,thremu,s11,s12,s13,s21,s22,s23,s31,s32,s33,sm,vmises,
     *peeqOld,peeq_rate,sig_y,dc,dw,sigdif,wc,x0,y0,dy0,dt,deqps1,
     *deqps2,f1
      integer::max_iter,n
...
c     Calculate the increment of dislocation density in the interior of the cell
      ...
      dcz2=(db*CMt*deqps*6.d0)/(b*(1-f)**(1.d0/3.d0)*d)
      dcz3=dc*CMt*deqps*Ckc
     *    *((CMt*deqps/(dt*yc))**(1.d0/(-Cnc)))
      dcz=dcz1-dcz2-dcz3
c     Calculate the increment of dislocation density in the cell walls
      dwz1=(CMt*deqps*6.d0*db*((1.d0-f)**(2.d0/3.d0)))
     *    /(d*b*f)
      dwz2=(sqrt(3.d0)*sqrt(dw)*db*(1.d0-f)*CMt*deqps)
     *    /(b*f)
      dwz3=CMt*deqps*dw*Ckw
     *    *((CMt*deqps/(dt*yc))**(1.d0/(-Cnw)))
      dwz=dwz1+dwz2-dwz3
